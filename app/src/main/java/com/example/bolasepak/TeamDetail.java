...
//    private RequestQueue requestQueue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPagerAdapter.AddFragment(new FragmentNextMatch(idTeam, isConnected()), "Next Matches");
        viewPagerAdapter.AddFragment(new FragmentPastMatch(idTeam, isConnected()), "Past Matches");
